...
class TypoScriptConfigOption extends AbstractExtConfigOption implements SingletonInterface
{
    ...
    public function registerStaticTsDirectory(
        ...
        string $title = ''
    ): TypoScriptConfigOption {
        $this->typoScript->addStaticTsDirectory($this->context->getExtKey(), $this->replaceMarkers($path),
            $this->replaceMarkers($title));
     ...
     * @return \LaborDigital\Typo3BetterApi\TypoScript\TypoScriptConfigOption
     */
    public function registerPageTsConfigFile(
        string $path,
        bool $selectablePerPage = false,
        ?string $title = null
    ): TypoScriptConfigOption {
     ...
     * @return \LaborDigital\Typo3BetterApi\TypoScript\TypoScriptConfigOption
     */
    public function registerPageTsConfigDirectory(
        string $path = 'EXT:{{extKey}}/Configuration/TsConfig/Page/',
        string $extension = 'typoscript'
    ): TypoScriptConfigOption {
        $path = $this->replaceMarkers($path);
     ...
     * @return \LaborDigital\Typo3BetterApi\TypoScript\TypoScriptConfigOption
     */
    public function registerUserTsConfigDirectory(
        string $path,
        string $extension = 'typoscript'
    ): TypoScriptConfigOption {
        $path = $this->replaceMarkers($path);
