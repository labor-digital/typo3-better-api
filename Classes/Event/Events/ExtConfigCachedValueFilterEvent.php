...
class ExtConfigCachedValueFilterEvent {
	 ...
	 * @param bool                                                                  $useCache
	 */
	public function __construct($result, ?string $cacheKey, string $key, callable $generator,
								array $additionalData, ExtConfigContext $context, AbstractExtConfigOption $option, array $config, bool $useCache) {
		$this->result = $result;
