 ...
 *
 * Last modified: 2020.08.25 at 10:55
 */
...
class TypoScriptFileImportFilterEvent
{
    /**
     ...
     * @param   string  $filename
     *
     * @return TypoScriptFileImportFilterEvent
     */
    public function setFilename(string $filename): TypoScriptFileImportFilterEvent
    {
        $this->filename = $filename;
     ...
     * @return TypoScriptFileImportFilterEvent
     */
    public function setCycleCounter(int $cycleCounter): TypoScriptFileImportFilterEvent
    {
        $this->cycleCounter = $cycleCounter;
     ...
     * @return TypoScriptFileImportFilterEvent
     */
    public function setReturnFiles(bool $returnFiles): TypoScriptFileImportFilterEvent
    {
        $this->returnFiles = $returnFiles;
     ...
     * @return TypoScriptFileImportFilterEvent
     */
    public function setIncludedFiles(array $includedFiles): TypoScriptFileImportFilterEvent
    {
        $this->includedFiles = $includedFiles;
     ...
     * @return TypoScriptFileImportFilterEvent
     */
    public function setResult(?string $result): TypoScriptFileImportFilterEvent
    {
        $this->result = $result;
