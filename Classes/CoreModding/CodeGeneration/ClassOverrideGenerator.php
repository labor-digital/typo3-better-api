...
class ClassOverrideGenerator
{
    ...
    public static function registerOverride(
        ...
        if (class_exists($classToOverride, false)) {
            throw new ClassOverridesException('The class: ' . $classToOverride
                                              . ' can not be overridden, because it is already defined!');
        }
        if (static::hasClassOverride($classToOverride) && ! $overrule) {
            throw new ClassOverridesException('The class: ' . $classToOverride . ' is already overridden with: '
                                              . static::$overrideDefinitions[$classToOverride]
                                              . ' and therefore can not be overwritten again!');
        }
