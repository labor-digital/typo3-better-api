...
class RepositoryWrapper extends BetterRepository {
	...
	public function __get($name) {
		if (!property_exists($this->repository, $name)) return NULL;
		return $this->repository->$name;
	}
	
	public function __set($name, $value) {
		if (!property_exists($this->repository, $name)) return;
	...
	public function __call($methodName, $arguments) {
		if (!method_exists($this->repository, $methodName)) return NULL;
