 ...
 *
 * Last modified: 2021.10.25 at 13:23
 */
...
/**
 * Adds an option to set if existing records can be edited in the current field wizard
 */
class WizardAllowEditOption extends AbstractOption
{
    /**
