 ...
 *
 * Last modified: 2021.08.18 at 08:42
 */
...
class RuntimeCache extends AbstractExtendedCache
{
    /**
     * @inheritDoc
     */
    ...
    {
        return 't3baRuntime_' . parent::getCacheKey($keyArgsOrGenerator, $withEnvironment);
    }
