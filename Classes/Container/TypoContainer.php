...
class TypoContainer implements TypoContainerInterface, SingletonInterface {
	...
	public function has($id) {
		if (isset($this->hasStates[$id])) return $this->hasStates[$id];
	...
	public function get($id, array $options = []) {
		try {
			...
			throw new TypoContainerException(
				"Exception while resolving object: " . $id . ": " . $e->getMessage(), $e->getCode(), $e);
		}
	}
	...
	public function getObjectManager(): ObjectManagerInterface {
		if (isset($this->objectManager)) return $this->objectManager;
