...
class FlashMessageRenderingService implements SingletonInterface {
	 ...
	 */
	public function __construct(FlashMessageService $flashMessageService, FlashMessageRendererResolver $rendererResolver,
	...
	protected function addMessageInternal(int $type, string $message, string $header, array $options) {
		...
		$message = $this->container->get(FlashMessage::class,
			[
				"args" => [
					$message,
					$header,
