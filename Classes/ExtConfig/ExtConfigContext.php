...
class ExtConfigContext {
	...
	public function __construct(TypoContext $context) {
		$this->addToServiceMap([
			"SqlGenerator"       => TableSqlGenerator::class,
			"DataHandlerActions" => DataHandlerActionService::class,
			"TypoContext"        => $context,
			"Fs"                 => TempFs::makeInstance("extConfig"),
			"ExtensionRegistry"  => function (TypoContainerInterface $container) {
	...
	public function __injectOptionList($optionList) {
		if (!$optionList instanceof ExtConfigOptionList) throw new ExtConfigException("The given option list is not valid!");
