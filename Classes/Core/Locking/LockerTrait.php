...
namespace LaborDigital\T3ba\Core\Locking;
...
{
    /**
     * Defines how many wait loops (100ms each) should be executed before
     * the lock acquisition is considered "failed" and the script continues anyway.
     * 100 is the default -> 10 seconds
     *
     * @var int
     */
    protected $waitForLockLoops = 100;
