 ...
 *
 * Last modified: 2021.06.11 at 19:00
 */
...
class TsBuilder
{
    public static function build(string $signature, AbstractElementConfigurator $configurator): ?string
    {
        ...
        return '# Register additional typo script ' . $signature .
               PHP_EOL . $typoScript;
    }
}