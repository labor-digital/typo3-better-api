...
';
     ...
     * @see https://docs.typo3.org/m/typo3/reference-coreapi/master/en-us/ApiOverview/TypoScriptSyntax/Syntax/Includes.html#includes
     */
    public function registerUserTsConfigImport(string $path = 'EXT:{{extKey}}/Configuration/TsConfig/Page/'): self
    {
...
';
     ...
     * @see https://docs.typo3.org/m/typo3/reference-coreapi/master/en-us/ApiOverview/TypoScriptSyntax/Syntax/Includes.html#includes
     */
    public function registerPageTsConfigImport(string $path = 'EXT:{{extKey}}/Configuration/TsConfig/User/'): self
    {
