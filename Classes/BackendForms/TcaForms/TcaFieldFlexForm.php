...
class TcaFieldFlexForm {
	...
	public function setFormSelectorField(?string $field): TcaFieldFlexForm {
		if (is_null($field)) unset($this->config["ds_pointerField"]);
	 ...
	 *
	 * By default the structure is "default" (who had thought...) and should be everything you need on a daily basis.
	...
	public function getForm(string $structure = "default"): FlexForm {
		...
		if (isset($this->structures[$structure])) return $this->structures[$structure];
