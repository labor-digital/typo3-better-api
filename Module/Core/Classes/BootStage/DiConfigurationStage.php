...
use LaborDigital\T3BA\Core\ExtConfigHandler\DependencyInjection\ConfigureDependencyInjectionHandler;
...
class DiConfigurationStage implements BootStageInterface
{
     ...
     *
     * @param   \LaborDigital\T3BA\Core\Event\PackageManagerCreatedEvent  $event
     */
     ...
     *
     * @param   \LaborDigital\T3BA\Core\Event\DiContainerBeingBuildEvent  $event
     */
     ...
     *
     * @param   \LaborDigital\T3BA\Core\Event\Internal\InternalCreateDependencyInjectionContainerEvent  $event
     */
    ...
    {
        $cache     = TempFs::makeCache('ExtConfig');
